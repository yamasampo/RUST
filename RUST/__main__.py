...
def parser():
    ...
    codon.add_argument('-P', '--Path', help='path to outputfile, default is "codon"',default = "codon")
    ...
    nucleotide.add_argument('-P', '--Path', help='path to outputfile, default is "nucleotide"',default = "nucleotide")
    ...
    dipeptide.add_argument('-P', '--Path', help='path to outputfile, default is "dipeptide"',default = "dipeptide")
    ...
    tripeptide.add_argument('-P', '--Path', help='path to outputfile, default is "tripeptide"',default = "tripeptide")
    ...
    predict.add_argument('-p', '--profiles', action ="store_true", help='writes all profiles in csv files, may produce >10,000 files',default = False)
