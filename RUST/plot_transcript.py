...
def main(args):
    ...
    if len(readlen_rangesplit) == 1: 
        ...
        stop_err( "l, lengths of footprints parameter not in correct format, it should be either colon seperated with the second value greater or equal to the first, (28:32) or a single interger (31)")
    ...
    if transcript_of_inter not in list_transcripts:
        ...
        sys.stdout.write( '%s not in Transcriptome file, data provided for %s\n' %(transcript_of_inter,transcript_of_inter2 ))
